CREATE TABLE CATEGORY(ID_CATEGORY INT PRIMARY KEY NOT NULL, NAME VARCHAR2(25), DESCRIPTION VARCHAR2(200));
...
-- Products
CREATE TABLE PRODUCT(ID_PRODUCT INT PRIMARY KEY NOT NULL, NAME VARCHAR2(25), DESCRIPTION VARCHAR2(200), ID_CATEGORY INT,
